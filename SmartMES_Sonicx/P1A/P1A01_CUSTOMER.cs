...
{
    public partial class P1A01_CUSTOMER : SmartMES_Sonicx.FormBasic
    {
        ...
        public void ListSearch()
        {
            try
            {
                ...
                string sFlag = "%";
                if (cbFlag.Text == "1.매출처") sFlag = "1";
                else if (cbFlag.Text == "2.매입처") sFlag = "2";

                sPW_Customer_QueryTableAdapter.Fill(dataSetP1A.SPW_Customer_Query, sSearch, sFlag);
        ...
        {
            string reportFileName = "SmartMES_Sonicx.Reports.P1A01_CUSTOMER.rdlc";
            ...
            ReportDataSource rds = new ReportDataSource("DataSet1", sPWCustomerQueryBindingSource);
