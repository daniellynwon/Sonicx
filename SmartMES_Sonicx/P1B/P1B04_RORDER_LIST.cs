...
{
    public partial class P1B04_RORDER_LIST : SmartMES_Sonicx.FormBasic
    {
        ...
        public void ListSearch()
        {
            try
            {
                ...
                sPS_ROrderList_QueryTableAdapter.Fill(dataSetP1B.SPS_ROrderList_Query, dtFromDate, dtToDate, sSearch);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (form.dataGridViewList.Rows[i].Cells[0].Value.ToString() == sID)
                    {
        ...
        private void pbPrint_Click(object sender, EventArgs e)
        {
            ...
            string reportFileName = "SmartMES_Sonicx.Reports.P1B04_RORDER_LIST.rdlc";

            string reportParm1 = "접수기간 : ";
            string reportParm2 = "조 회 : ";
            string reportParm3 = "";
            ...
            ReportDataSource rds = new ReportDataSource("DataSet1", sPSROrderListQueryBindingSource);
