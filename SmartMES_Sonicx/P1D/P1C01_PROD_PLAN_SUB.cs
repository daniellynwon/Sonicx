...
namespace SmartMES_Sonicx
{
    public partial class P1C01_PROD_PLAN_SUB : Form
    {
        ...
        private void Save()
        {
            ...
            string sql = "insert into productionplan(PlanDate, ProductID, SaleQty, ProdQty, Contents)" +
                    " values('" + sPlanDate + "', " + sProd + ", " + sSaleQty + ", " + sProdQty + ", '" + sBigo + "')" +
                    " on duplicate key update" +
                    " SaleQty = " + sSaleQty + ", ProdQty = " + sProdQty + ", Contents = '" + sBigo + "'";
