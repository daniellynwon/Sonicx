...
{
    public partial class P1Z02_USER : SmartMES_Sonicx.FormBasic
    {
        public P1Z02_USER()
        {
            InitializeComponent();
        ...
        public void ListSearch()
        {
            try
            {
                ...
                int iFlag = Int32.Parse(cbFlag.Text.Substring(0, 1));

                sP_User_QueryTableAdapter.Fill(dataSetP1Z.SP_User_Query, sSearch, iFlag);
